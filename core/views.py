...
def index(request):
    ...
    new_products = Product.objects.filter(product_status="published", featured=True).order_by("-date")[:3]   
...
def wheel_spinner(request):
    return render(request, "core/wheel-spinner.html")
